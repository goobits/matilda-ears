...
class TestEntityPriorities:
    ...
    def test_url_vs_filename_priority(self):
    ...
    def test_email_vs_filename_priority(self):
    ...
    def test_slash_command_vs_division_priority(self):
    ...
    def test_operator_vs_math_expression_priority(self):
    ...
    def test_number_entity_priorities(self):
...
class TestEntityBoundaries:
    ...
    def test_sentence_boundary_entities(self):
...
class TestAdjacentEntities:
    ...
    def test_adjacent_code_entities(self):
...
class TestComplexEntityInteractions:
    ...
    def test_technical_documentation_sentences(self):
    ...
    def test_mathematical_physics_sentences(self):
...
class TestEntityProtectionInFormatting:
    ...
    def test_url_protection_in_questions(self):
    ...
    def test_email_protection_in_sentences(self):
    ...
    def test_code_protection_in_capitalization(self):
...
class TestEdgeCaseInteractions:
    ...
    def test_ambiguous_entity_detection(self):
    ...
    def test_entity_in_quoted_text(self):
