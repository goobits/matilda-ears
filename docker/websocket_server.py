...
class EnhancedSTTWebSocketServer:
    ...
    def __init__(self, host: str = "0.0.0.0", websocket_port: int = 8769, web_port: int = 8080):
        ...
        logger.info(f"Enhanced STT WebSocket Server initialized")
    ...
    def _generate_ssl_certificates(self):
        ...
        try:
            ...
            cmd = [
                ...
                "-days", "365", "-nodes",
                "-subj", "/C=US/ST=State/L=City/O=STT/OU=Server/CN=localhost"
            ]
        ...
        try:
            ...
            async with httpx.AsyncClient() as client:
                response = await client.get(
                    f"http://localhost:{self.web_port}/api/validate-token",
                    params={"token": token}
                )
                ...
                if response.status_code == 200:
                    ...
                    await self.send_response(websocket, client_id, {
                        "type": "auth_success",
    ...
    async def handle_end_stream(self, websocket: WebSocketServerProtocol, data: Dict, client_id: str, client_ip: str):
        ...
        await self.send_response(websocket, client_id, {
            "type": "stream_ended",
            "text": "Streaming transcription complete"
        })
