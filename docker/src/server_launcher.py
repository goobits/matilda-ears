...
logging.basicConfig(
    ...
    handlers=[logging.StreamHandler(), logging.FileHandler("/app/logs/server_launcher.log")],
)
...
class DockerServerLauncher:
    ...
    def __init__(self):
        ...
        logger.info("Server launcher initialized")
    ...
    def start_dashboard(self):
        ...
        try:
            ...
            uvicorn.run(app, host=self.host, port=self.web_port, log_level=log_level, access_log=True, loop="asyncio")
