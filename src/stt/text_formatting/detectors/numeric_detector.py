...
class NumericalEntityDetector:
    ...
    def _detect_consecutive_digits(
    ...
    def _detect_scientific_notation(
        self, text: str, entities: list[Entity], all_entities: list[Entity] | None = None
    ) -> None:
        """
